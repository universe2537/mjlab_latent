...
register_mjlab_task(
  task_id="Mjlab-Tracking-TableTennis-Unitree-G1",
  env_cfg=unitree_g1_table_tennis_tracking_env_cfg(),
  play_env_cfg=unitree_g1_table_tennis_tracking_env_cfg(play=True),
  rl_cfg=unitree_g1_table_tennis_tracking_ppo_runner_cfg(),
  runner_cls=MotionTrackingOnPolicyRunner,
)
