from mjlab.tasks.distillation.runner import OnlineDistillationRunner
from mjlab.tasks.registry import register_mjlab_task

from .distill_cfg import unitree_g1_distillation_runner_cfg
from .env_cfgs import unitree_g1_distillation_env_cfg
