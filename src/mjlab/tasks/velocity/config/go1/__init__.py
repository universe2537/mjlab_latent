...
register_mjlab_task(
  task_id="Mjlab-Velocity-Stairs-Unitree-Go1",
  env_cfg=unitree_go1_stairs_env_cfg(),
  play_env_cfg=unitree_go1_stairs_env_cfg(play=True),
  rl_cfg=unitree_go1_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
